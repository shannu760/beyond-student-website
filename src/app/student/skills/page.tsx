...
const SKILLS: SkillItem[] = [
  ...
  },
  {
    ...
    color: "violet",
    tagline: "From Three.js official docs + free Coursera tracks",
    exercises: [
      {
        title: "Three.js Official Documentation — Getting Started",
        difficulty: "Easy",
        type: "Tutorial",
        url: "https://threejs.org/docs/#manual/en/introduction/Installation",
        source: "threejs.org (Official)",
        description: "Install Three.js, create your first scene, add a mesh, lighting, and animate a 3D cube.",
        estimatedTime: "1 hr",
        free: true
      },
      {
        title: "Three.js Journey — Full Free Introduction (Chapter 1–5)",
        difficulty: "Easy",
        type: "Course",
        url: "https://threejs-journey.com/",
        source: "Three.js Journey (Official Free Chapters)",
        description: "Bruno Simon's world-famous Three.js course — first 5 chapters are free: scene, geometry, materials, textures.",
        estimatedTime: "4 hrs",
        free: true
      },
      {
        title: "Three.js Fundamentals (Official Partner Site)",
        difficulty: "Easy",
        type: "Tutorial",
        url: "https://threejsfundamentals.org/",
        source: "threejsfundamentals.org",
        description: "Step-by-step tutorial from the official Three.js team — cameras, lights, shadows, textures, primitives.",
        estimatedTime: "3 hrs",
        free: true
      },
      {
        title: "Creative Coding with JavaScript & Three.js — Coursera",
        difficulty: "Medium",
        type: "Course",
        url: "https://www.coursera.org/learn/creative-coding",
        source: "Coursera (Free to Audit)",
        description: "Audit free — covers 2D canvas, WebGL basics, and transitions to Three.js 3D scenes.",
        estimatedTime: "8 hrs",
        free: true
      },
      {
        title: "Interactive 3D Graphics — Udacity (Free)",
        difficulty: "Medium",
        type: "Course",
        url: "https://www.udacity.com/course/interactive-3d-graphics--cs291",
        source: "Udacity (Free Course)",
        description: "Free Udacity course covering WebGL fundamentals, shaders, transformations, lighting models.",
        estimatedTime: "10 hrs",
        free: true
      },
      {
        title: "Next.js + Three.js — Official Integration Guide",
        difficulty: "Medium",
        type: "Tutorial",
        url: "https://nextjs.org/docs/app/building-your-application/optimizing/third-party-libraries",
        source: "nextjs.org (Official Docs)",
        description: "How to correctly integrate Three.js into a Next.js App Router project, dynamic imports, SSR handling.",
        estimatedTime: "1 hr",
        free: true
      },
      {
        ...
        source: "docs.pmnd.rs (Official R3F)",
        description: "React Three Fiber is the standard way to use Three.js in React/Next.js — declarative 3D scenes.",
        estimatedTime: "2 hrs",
        free: true
      },
      {
        ...
        description: "Browse 300+ live, inspectable demos from the Three.js core team — animations, shaders, physics, VR.",
        estimatedTime: "Ongoing",
        free: true
      },
      {
        title: "Shader Programming — GLSL on ShaderToy",
        difficulty: "Hard",
        type: "Project",
        url: "https://www.shadertoy.com/",
        source: "ShaderToy (Community)",
        description: "Write GLSL fragment shaders directly in browser — the visual programming language powering 3D rendering.",
        estimatedTime: "5 hrs",
        free: true
      },
      {
        title: "Computer Graphics — Coursera (UC San Diego)",
        difficulty: "Hard",
        type: "Course",
        url: "https://www.coursera.org/learn/computer-graphics",
        source: "Coursera (UC San Diego — Free Audit)",
        description: "Full computer graphics theory: transformations, rasterization, ray tracing, OpenGL — audit for free.",
